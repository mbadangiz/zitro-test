    ...
    <div className="grid grid-cols-12 lg:gap-x-6">
      ...
      <div className="col-span-12 lg:col-span-7 space-y-4 px-4 ">
        ...
        <p className="py-2 text-xs leading-6 text-justify hidden lg:block text-primary-text-light">
          ...
          با دلیل &quot;انصراف از خرید&quot; و در صورتی پذیرفته می‌شود که کالا
          در شرایط اولیه خود باشد (در صورت پلمپ بودن، نباید باز شده باشد).
          مانیتور با تعداد بالای 3 پیکسل سوخته فقط شامل ضمانت بازگشت می‌شود.
        </p>
      </div>
    </div>
  );
